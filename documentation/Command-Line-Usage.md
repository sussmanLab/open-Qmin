...
Run `build/openQmin` with any of the available command-line options, which are described [here](Command-Line-Options) in detail; for a brief summary you can type `build/openQmin --help`.
